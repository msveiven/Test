...
tree = ET.parse(str(sys.argv[1]))  #uses ET function on the xml file
...
elif os.path.isfile('C:/Users/msveiven/Documents/Github/Test/customParameters.txt') == True and os.path.isfile('C:/Users/msveiven/Documents/Github/Test/complexParameters.txt') == True:
    parameterList = [line.rstrip('\n') for line in open('C:/Users/msveiven/Documents/Github/Test/customParameters.txt')]    #creates a list by reading parameters from text file
    print(parameterList)
    complexParameterList = [line.rstrip('\n') for line in open('C:/Users/msveiven/Documents/Github/Test/complexParameters.txt')]
else:
...
f.write('<br>')
f.write('</br>')
f.write('<img src="Image.png" alt="Placer Image" style="width:304px;height:228px;">')
f.write('</body>\n')
f.write('<html>\n')
